...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    cypher_llm=AzureChatOpenAI(model=HOSPITAL_CYPHER_MODEL,api_version=os.environ["OPENAI_API_VERSION"],temperature=0),
    qa_llm=AzureChatOpenAI(model=HOSPITAL_QA_MODEL,api_version=os.environ["OPENAI_API_VERSION"],temperature=0),
    graph=graph,
    verbose=True,
